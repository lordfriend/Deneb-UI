...
export class UIDialog {
    ...
    createDialogContent<T>(component: Type<T>, container: DialogContainer, config: DialogConfig): UIDialogRef<T> {
        let dialogRef = new UIDialogRef<T>(container, this._componentFactoryResolver, this._appRef, config);
